...
public class TambahView extends JFrame{
    ...
    JButton tambahButton, kembaliButton;
    ...
    private void tambahButton(int x, int y){
        tambahButton = new JButton("tambah");
        tambahButton.setBounds(x, y, 100, 30);
        add(tambahButton);
        ...
        tambahButton.addActionListener((e) -> {
            ...
            if (_bookC.cari(code) == null){
                _bookC.tambah(judul, code, penulis, penerbit);
            }
            else
